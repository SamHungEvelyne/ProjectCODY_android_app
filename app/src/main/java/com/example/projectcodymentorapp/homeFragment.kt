...
class homeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pending_button.setOnClickListener {
            findNavController().navigate(R.id.action_menuHome_to_menuPending)
        }
        classes_button.setOnClickListener {
            findNavController().navigate(R.id.action_menuHome_to_menuClasses)
        }
        students_button.setOnClickListener {
            findNavController().navigate(R.id.action_menuHome_to_menuStudents)
        }
